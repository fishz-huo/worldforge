  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        'rounded-lg border border-border bg-card p-4 shadow-lg duration-150',
    ...
    >
      {children}
      {!hideClose && (
        <DialogPrimitive.Close className="absolute right-3 top-3 rounded opacity-60 transition-opacity hover:opacity-100">
          <X className="size-4" />
